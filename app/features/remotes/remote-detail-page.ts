...
function detailItem(label: string, value?: string, valueClassName = ""): HTMLDivElement {
...
function copyableDetailItem(label: string, value?: string): HTMLDivElement {
    const wrapper = document.createElement("div");
    wrapper.className = "detail-item";
...
function renderRolePills(remote: RemoteRecord): HTMLElement {
...
export function renderRemoteDetailPage({ vault, remote }: RemoteDetailProps) {
    return {
        title: remote.alias,
